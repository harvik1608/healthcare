...
<html lang="en" class="light-style layout-wide  customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="../assets/" data-template="vertical-menu-template-free" data-style="light">
	...
	<body>
			...
			<div class="layout-container">
				<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
					...
					<ul class="menu-inner py-1" id="main-menu">
						...
						<li class="menu-item">
							<a href="{{ route('user.professionals') }}" class="menu-link">
								<i class="menu-icon tf-icons bx bx-crown"></i>
								<div class="text-truncate" data-i18n="Boxicons">Professionals</div>
							</a>
						</li>
						<li class="menu-item">
							<a href="{{ route('user.appointments') }}" class="menu-link">
								<i class="menu-icon tf-icons bx bx-crown"></i>
								<div class="text-truncate" data-i18n="Boxicons">My Appointments</div>
							</a>
						</li>
					</ul>
				</aside>
								...
								<li class="nav-item navbar-dropdown dropdown-user dropdown">
									<a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
										<div class="avatar avatar-online">
											<img src="https://embellishlondon.com/daily_entry/public/assets/img/avatars/1.png" alt class="w-px-40 h-auto rounded-circle" />
										</div>
									</a>
									<ul class="dropdown-menu dropdown-menu-end">
										...
										<li><a class="dropdown-item" href="{{ route('user.logout') }}"><i class="bx bx-power-off bx-md me-3"></i><span>Log Out</span></a></li>
									</ul>
								</li>
							</ul>
						</div>
		...
		<script>
			$(document).ready(function(){
				...
				$("#bookAppointmentForm").submit(function(e){
					...
					if($("#bookAppointmentForm").valid()) {
						$.ajax({
							url: $("#bookAppointmentForm").attr("action"),
							type: $("#bookAppointmentForm").attr("method"),
							data: new FormData(this),
							contentType: false,
							processData: false,
							cache: false,
							beforeSend:function(){
								$("#bookAppointmentForm button[type=submit]").html('Processing...').attr("disabled",true);
							},
			...
			function book_now(id,stime,etime)
		    {
		    	$("#professional_id").val(id);
		    	$("#stime").val(stime);
		    	$("#etime").val(etime);
