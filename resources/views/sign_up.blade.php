				...
				<div class="authentication-inner">
					<div class="card px-sm-6 px-0">
						<div class="card-body">
							...
							<form class="mb-6" action="{{ route('user.signup') }}" method="post" id="signup-form">
								...
								<div class="mb-6">
									...
									<input type="number" class="form-control" id="phone" name="phone" placeholder="Enter your mobile no." value="{{ old('phone') }}" />
								</div>
								<div class="mb-6">
								...
								<center><span>Already have an account? <a href="{{ route('user.sign-in') }}"><span>Sign in</span></a></span></center>
							</form>
						</div>
					</div>
				</div>
			...
			$(document).ready(function() {
				...
				$("#signup-form").validate({
					...
					messages:{
						...
						phone:{
							required: "<b>Mobile no. is required.</b>"
						},
						email:{
