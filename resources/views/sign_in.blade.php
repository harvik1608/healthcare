				...
				<div class="authentication-inner">
					<div class="card px-sm-6 px-0">
						<div class="card-body">
							...
							<form id="signin-form" class="mb-6" action="{{ route('submit-signin') }}" method="post">
								...
								<center><span>Don't have an account? <a href="{{ route('user.sign-up') }}"><span>Sign up</span></a></span></center>
							</form>
						</div>
					</div>
				</div>
